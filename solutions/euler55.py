...
A number that never forms a palindrome through the reverse and add process is called a Lychrel number. D
...
from utils.numbers import is_probable_lynchrel

counter = 0
for n in range(10, 10_000):
    if is_probable_lynchrel(n, 50):
        counter += 1
print(counter)